...
void function GamemodeAITdm_Init()
{
	...
	if ( GetCurrentPlaylistVarInt( "aitdm_archer_grunts", 0 ) == 0 )
	{
		...
		if (GetConVarString("sv_npc_spectre_weapons") == "")
			AiGameModes_SetNPCWeapons( "npc_spectre", [ "mp_weapon_hemlok", "mp_weapon_hemlok_smg", "mp_weapon_doubletake", "mp_weapon_mastiff" ] )
		if (GetConVarString("sv_npc_stalker_weapons") == "")
			AiGameModes_SetNPCWeapons( "npc_stalker", [ "mp_weapon_hemlok_smg", "mp_weapon_lstar", "mp_weapon_mastiff", "mp_weapon_esaw" ] )
